...
uv run niuma todo list --title-only
uv run niuma todo list --content-limit 50
uv run niuma todo show 1
...
uv run niuma search "支付"
uv run niuma search "支付" --entity todo
uv run niuma search "支付" --content-limit 50
